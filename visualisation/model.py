...
# model_total_validation("data/past/validation_groupby_JOUR.csv", is_model_load=True, plot=True)
# model_titre_validation("data/past/validation_groupby_JOUR_CATEGORIE_TITRE.csv", is_model_load=True, plot=True)
# model_arret_validation("data/past/validation_groupby_JOUR_LIBELLE_ARRET.csv", is_model_load=True, plot=True)
